...
public partial class OnlineFoodContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=ACERNITRO\\SQLEXPRESS;Database=OnlineFood;User Id=sa;Password=123;TrustServerCertificate=True;Trusted_Connection=True;");
